    ...
    <form className={cn("flex flex-col gap-6", className)} onSubmit={handleSubmit(onSubmit)} {...props}>
      ...
      <div className="grid gap-6">
        ...
        <div className="grid gap-3">
          ...
          />
          <AnimateErrors error={errors.password?.message} variant="field" />
        </div>
        <div className="grid gap-3">
          <div className="flex items-center">
          ...
          />
          <AnimateErrors error={errors.confirmPassword?.message} variant="field" />
        </div>
        <AnimateErrors 
          error={message && !message.includes("successfully") ? message : null} 
          variant="toast" 
          type="error" 
        />
        <AnimateErrors 
